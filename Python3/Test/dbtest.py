...
class loadData():
        def __init__(self):
                try:
                        ...
                        self.conn=pymysql.connect(host='10.250.100.17', user="",passwd="",port=3306,db="campaign",charset="utf8")#MySQLdb.connect(host=ip,user="root",passwd="root",db="svmtest",charset="utf8", local_infile = 1)#"crawler_db2"

                        #self.conn=MySQLdb.connect(host='54.223.169.91', user="root",passwd="root",port=3306,db="social_media",charset="utf8")#MySQLdb.connect(host=ip,user="root",passwd="root",db="svmtest",charset="utf8", local_infile = 1)#"crawler_db2"
                        #self.conn=MySQLdb.connect(host='172.26.93.6', user="root",passwd="123456",port=3306,db="social_media",charset="utf8")#MySQLdb.connect(host=ip,user="root",passwd="root",db="svmtest",charset="utf8", local_infile = 1)#"crawler_db2"
        ...
        def dataInsert(self,data):#172.26.93.6
                        ...
                        try:
                                sql="insert  into `PG_AD_KEYWORD`(`MONITOR_CODE`,`PROMOTION_PLAN`,`KEYWORD`,`KEYWORD_CODE`) values "+"( '"
...
if __name__=="__main__":
        ...
        #         finally:
        #                 print ( "hhh"
        data=codecs.open(u'C:\\Users\\liuzj7\\Desktop\\key_code.txt','r','utf-8')
        item=data.readline()
        while len(item)>0:
